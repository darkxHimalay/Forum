...
<%@ page import="model.SaveQuestion"
    import="java.sql.*"%>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="#"style="color: black">Login/SignUp<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    <a class="dropdown-item" href="# "style="color: black">Any other Action </a>
                    <a class="dropdown-item" href="# "style="color: black">Any Another action2</a>
        ...
        <div class="col-3" style="float: right;">
          ...
          width:7rem;margin-left:100px;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Java/sqa</li>
                </ul>
            </div>
        </div>
    </div>
